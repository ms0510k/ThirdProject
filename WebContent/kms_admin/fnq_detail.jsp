...
<a href="<%=request.getContextPath()%>/admin.do?cmd=fnq_list&email=<%=email%>" style="margin-right: 350px;">자주묻는 질문 목록</a><br><br>
...
%>
<a href="<%=request.getContextPath()%>/admin.do?cmd=fnq_delete&fnqnum=${vo.fnqnum}&email=<%=email%>">삭제</a>
<a href="<%=request.getContextPath()%>/admin.do?cmd=fnq_update&fnqnum=${vo.fnqnum}&email=<%=email%>">수정</a>
<%} %>
</div>
</body>
</html>